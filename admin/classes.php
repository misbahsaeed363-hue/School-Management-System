...
<main class="main-content">
            ...
            <div class="metrics-card">
                ...
                <div class="metrics-info">
                    ...
                    <p>
                        ...
                        $_SESSION['total_classes'] = $row1['total_classes'];
            ...
            <div class="metrics-card glass-card">
                ...
                <div class="metrics-info">
                    ...
                    <p>
                        ...
                        $_SESSION['total_sections'] = $row2['total_sections'];
            ...
            <div class="metrics-card">
                ...
                <div class="metrics-info">
                    ...
                    <p>
                        ...
                        $_SESSION['total_students'] = $row3['total_students'];
    ...
    include  $_SERVER['DOCUMENT_ROOT'] . "/school_management_system/includes/admin/add_section_modal.php";

    // SECTION DETAIL MODAL
    include  $_SERVER['DOCUMENT_ROOT'] . "/school_management_system/includes/admin/section_Detail_modal.php";

    // SUBJECT LIST MODAL
    include  $_SERVER['DOCUMENT_ROOT'] . "/school_management_system/includes/admin/subject_list_modal.php";
