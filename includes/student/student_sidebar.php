    ...
    <div class="wrapper">
        ...
        <aside class="sidebar glass-card" id="sidebar">
            <div>
                ...
                <a href="/school_management_system/student/dashboard.php">
                    <div class="nav-item <?= ($currentPage == 'dashboard.php' ? 'active' : '') ?>" title="Dashboard">
                ...
                <a href="/school_management_system/student/attendance.php">
                ...
                <a href="/school_management_system/student/profile.php">
