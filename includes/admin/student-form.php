    ...
    <form action="addphp.php" method="post" enctype="multipart/form-data" id="studentForm">
        ...
        <div class="modal-container student">
            ...
            <div class="modal-header mobile">
                <h3 class="modal-heading">Add new Student</h3>
            ...
            <div class="left-modal">
                ...
                <div class="profile-wrapper">
                    ...
                    <div class="card-picture" id="student-card-picture">
                    ...
                    <!-- Image input  -->
                    <input type="file" name="image" id="image-input" class="student-image-input">
